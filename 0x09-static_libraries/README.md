...
Static libraries in C are pre-compiled collections of object files that can be linked into a program to create a self-contained executable.
...
[libmy.a](./libmy.a), [main.h](./main.h) - Create the static library `libmy.a` containing all the functions listed below:
